    ...
    <div className="min-h-screen flex flex-col bg-linear-to-br from-[#f8faf9] to-[#e8f5e9]">
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="mt-12 grid grid-cols-3 gap-6">
                  ...
                  <div className="text-center lg:text-left">
                    <div className="text-3xl sm:text-4xl font-bold text-[#8baab1]">50+</div>
                    <div className="text-sm text-[#060404]/60 mt-1">Quizzes</div>
                  </div>
                  <div className="text-center lg:text-left">
                    <div className="text-3xl sm:text-4xl font-bold text-[#68ba4a]">50+</div>
              ...
              <div className="relative">
                <div className="relative bg-white rounded-3xl p-8 border-2 border-[#e8f5e9]">
                  <div className="flex items-center justify-center">
                    <div className="w-64 h-64 sm:w-80 sm:h-80 rounded-2xl bg-linear-to-br from-[#68ba4a]/20 to-[#8baab1]/20 flex items-center justify-center">
                      <i className="fas fa-brain text-[#68ba4a] text-8xl sm:text-9xl"></i>
                    </div>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#060404] mb-4">
                Why Choose{" "}
                <span className="bg-linear-to-r from-[#68ba4a] to-[#8baab1] bg-clip-text text-transparent">
                  LogicTutor
                </span>
                ?
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Feature 1 */}
              <div className="bg-linear-to-br from-[#f8faf9] to-[#f0f7f1] rounded-2xl p-8 border-2 border-[#e8f5e9] hover:border-[#68ba4a]/30 transition-all hover:shadow-xl group">
        ...
        <section className="py-16 sm:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-linear-to-br from-[#68ba4a] to-[#8baab1] rounded-3xl p-12 sm:p-16 text-center shadow-2xl relative overflow-hidden">
              {/* Background Pattern */}
